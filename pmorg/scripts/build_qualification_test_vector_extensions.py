#!/usr/bin/env python3
"""Write or verify unactivated candidate-level vector extensions."""
...
def main() -> int:
    ...
    if arguments.write:
        write_qualification_test_vector_extension(arguments.repository_root)
    else:
        check_qualification_test_vector_extension(arguments.repository_root)
    return 0
