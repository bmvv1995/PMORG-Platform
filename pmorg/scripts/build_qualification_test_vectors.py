#!/usr/bin/env python3
"""Write or verify candidate-level qualification test vectors."""
...
def main() -> int:
    ...
    if arguments.write:
        write_qualification_test_vectors(arguments.repository_root)
    else:
        check_qualification_test_vectors(arguments.repository_root)
    return 0
