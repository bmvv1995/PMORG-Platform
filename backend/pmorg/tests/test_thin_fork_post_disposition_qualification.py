...
from pmorg.application.thin_fork_post_disposition_qualification import (
    BASE_PLATFORM_COMMIT,
)
from pmorg.application.thin_fork_post_disposition_qualification import (
    check_thin_fork_post_disposition_qualification,
)
from pmorg.application.thin_fork_post_disposition_qualification import INDEX_RELATIVE
from pmorg.application.thin_fork_post_disposition_qualification import index_schema
from pmorg.application.thin_fork_post_disposition_qualification import MANIFEST_RELATIVE
from pmorg.application.thin_fork_post_disposition_qualification import REPORT_RELATIVE
from pmorg.application.thin_fork_post_disposition_qualification import REPOSITORY_ROOT
from pmorg.application.thin_fork_post_disposition_qualification import RUNNER_RELATIVE
from pmorg.application.thin_fork_post_disposition_qualification import TEST_COUNT
from pmorg.application.thin_fork_post_disposition_qualification import (
...
class ThinForkPostDispositionQualificationTests(unittest.TestCase):
    def test_committed_evidence_graph_is_closed_and_valid(self) -> None:
        check_thin_fork_post_disposition_qualification(REPOSITORY_ROOT)
        ...
        self.assertEqual(
            "thin_fork_post_disposition_qualification_only_no_disposition",
    ...
    def test_manifest_projects_exact_bounded_suite_and_trust_paths(self) -> None:
        ...
        self.assertEqual(
            [VERIFY_FORK_RELATIVE, VERIFY_FORK_TEST_RELATIVE],
